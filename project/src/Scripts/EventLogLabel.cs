...
"[ItemValue] coins richer, [Name] triumphantly wields [ItemName] on their journeys.",
    ...
    public List<object> GetRandomTextOnItemSold(EventLogLabelText adventurer, string itemValue, string itemName)
    {
    ...
    private void OnItemSold(Item item, Adventurer adventurer)
    {
        ...
        adventurerName.AddThemeColorOverride("default_color", Colors.Yellow); // Color.FromHtml(colour)
